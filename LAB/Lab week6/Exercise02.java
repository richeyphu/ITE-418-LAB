...
public class Exercise02 {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 3:
				...
				index = sc.nextInt();
				sc.nextLine();
				System.out.println("Your order is [" + sl.get(index) + "]");
			...
			case 5:
				...
				input = sc.nextInt();
				sc.nextLine();
				System.out.println("Your menu " + (sl.indexOf(getMenu(input)) == -1 ? "is not found"
						: "(" + getMenu(input) + ") is found in index [" + sl.indexOf(getMenu(input)) + "]"));
				break;
			...
			case 6:
				...
				input = sc.nextInt();
				sc.nextLine();
				System.out.println(sl.contains(getMenu(input)) ? "This menu (" + getMenu(input) + ") is found!"
			...
			case 8:
				...
				index = sc.nextInt();
				sc.nextLine();
				System.out.println("\"" + sl.get(index) + "\" in Index [" + index + "] has been removed!");
				sl.remove(index);
				break;
	...
	public static String[] toArray(SinglyLinkedList sl) {
		String[] a = new String[sl.size()];
	...
	public static void checkout(String[] a) {
		...
		System.out.println(line);
		System.out.println("  Thank You for using KFC SinglyLinkedList Edition!");
